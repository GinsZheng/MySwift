...
extension UILabel {
    ...
    func makeConstraints(left: CGFloat, centerY: UIView) {
        self.frame.size = CGSize(width: getLabelWidth(), height: getDefaultLineheight())
        self.frame.origin.x = left
        self.frame.origin.y = (centerY.height - self.height) / 2
    }
    ...
    func makeConstraints(centerX: UIView, top: CGFloat) {
        self.frame.size = CGSize(width: getLabelWidth(), height: getDefaultLineheight())
        self.frame.origin.x = (centerX.width - self.width) / 2
    ...
    func makeConstraints(centerX: UIView, bottom: CGFloat) {
        self.frame.size = CGSize(width: getLabelWidth(), height: getDefaultLineheight())
        self.frame.origin.x = (centerX.width - self.width) / 2
        self.frame.origin.y = self.superview!.height - self.height - bottom
    }
    ...
    func makeConstraints(right: CGFloat, centerY: UIView) {
        self.frame.size = CGSize(width: getLabelWidth(), height: getDefaultLineheight())
        self.frame.origin.x = self.superview!.width - self.width - right
        self.frame.origin.y = (centerY.height - self.height) / 2
    }
...
extension UIView {
    ...
    func makeConstraints(left: CGFloat, centerY: UIView, width: CGFloat, height:CGFloat) {
        self.frame.size = CGSize(width: width, height: height)
        self.frame.origin.x = left
        self.frame.origin.y = (centerY.height - self.height) / 2
    }
    ...
    func makeConstraints(centerX: UIView, top: CGFloat, width: CGFloat, height:CGFloat) {
        self.frame.size = CGSize(width: width, height: height)
        self.frame.origin.x = (centerX.width - self.width) / 2
        self.frame.origin.y = top
    }
    ...
    func makeConstraints(centerX: UIView, bottom: CGFloat, width: CGFloat, height:CGFloat) {
        self.frame.size = CGSize(width: width, height: height)
        self.frame.origin.x = (centerX.width - self.width) / 2
        self.frame.origin.y = self.superview!.height - self.height - bottom
    }
    ...
    func makeConstraints(right: CGFloat, centerY: UIView, width: CGFloat, height:CGFloat) {
        self.frame.size = CGSize(width: width, height: height)
        self.frame.origin.x = self.superview!.width - self.width - right
        self.frame.origin.y = (centerY.height - self.height) / 2
    }
